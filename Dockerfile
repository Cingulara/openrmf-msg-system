...
USER 1001
ENTRYPOINT ["./openrmf-msg-system"]

LABEL org.opencontainers.image.source=https://github.com/Cingulara/openrmf-msg-system
LABEL org.opencontainers.image.authors="dale.bingham@cingulara.com"
LABEL org.opencontainers.image.description="This is the system package message client to capture pub/sub messages and react accordingly for OpenRMF OSS"
LABEL org.opencontainers.image.vendor="Cingulara LLC and Tutela LLC"
LABEL org.opencontainers.image.title="OpenRMF OSS System Package Message Client"